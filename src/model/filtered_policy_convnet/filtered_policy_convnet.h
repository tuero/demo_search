...
#ifndef HPTS_MODEL_FILTERED_POLICY_CONVNET_H_
#define HPTS_MODEL_FILTERED_POLICY_CONVNET_H_
...
class FilteredPolicyConvNetImpl : public torch::nn::Module {
public:
    /**
     ...
     */
    FilteredPolicyConvNetImpl(const ObservationShape &observation_shape, int num_actions, int resnet_channels, int resnet_blocks,
...
TORCH_MODULE(FilteredPolicyConvNet);

}    // namespace hpts::model::network

#endif    // HPTS_MODEL_FILTERED_POLICY_CONVNET_H_
