...
TwoHeadedConvNetImpl::TwoHeadedConvNetImpl(const ObservationShape &observation_shape, int num_actions, int resnet_channels,
                                           int resnet_blocks, int policy_channels, int heuristic_channels,
